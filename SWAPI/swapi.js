const formItems = {
    ...
    shipName: document.getElementById('name'),
    shipModel: document.getElementById('model'),
    shipClass: document.getElementById('class'),
    shipMovies: document.getElementById('movies')
}
...
function renderShipDetails(shipData) {
    ...
    console.log(typeof shipData);

    formItems.shipName.innerHTML = shipData.name;
    formItems.shipModel.innerHTML = shipData.model;
    formItems.shipClass.innerHTML = shipData.starship_class;
    formItems.shipMovies.innerHTML = shipData.films.length;
    formItems.detailsBox.className = 'visible';
